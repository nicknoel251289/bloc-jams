...
window.onload = function() {
    ...
    /* function animateAlbum(a){
       a.songs.style.opacity = 1;
       a.songs.style.transform = "scaleX(1) translateX(0)";
       a.songs.style.msTransform = "scaleX(1) translateX(0)";
       a.songs.style.WebkitTransform = "scaleX(1) translateX(0)";
     }*/

    albumImage.addEventListener("click", function(event){
      setCurrentAlbum(albums[index]);
      animateAlbum(albums[index]);
      index++;
